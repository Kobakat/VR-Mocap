...
public class SandboxBase : MonoBehaviour
{
	protected virtual void Awake()
	{
		...
		{
			//place a SandboxItemChild on all transforms so scripts know this is a sandbox item, prevents it from being rewond and stuff..
			if (child.gameObject.GetComponent<SandboxItemChild>() == null)
			{
				//only need one, incase something already added one to this object
