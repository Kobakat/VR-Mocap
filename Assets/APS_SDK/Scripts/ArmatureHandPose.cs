...
namespace APS
{
	...
	class ArmatureHandPoseEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			GUILayout.Label(
				"Used by the auto-populatate transforms inspector script to indicate that this is the prefered finger orientation template for properly orientating all fingers of this character",
				customLabel);
	...
	public class ArmatureHandPose : MonoBehaviour
	{
		...
		[Header("_Thumb Targets_")] public Transform clinched_target;
		public Transform rest_target;
		public Transform open_target;

		[Header("_Hand_")] public Transform hand;
		[Header("_Fingers_")] public Transform thumb;
